		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mahindra Workflow UI",
									"targetURL": "#MahindraWorkflowworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MahindraWorkflowworkflowuimodule-display": {
								"semanticObject": "MahindraWorkflowworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MahindraWorkflow.workflowuimodule",
									"url": sap.ui.require.toUrl("MahindraWorkflow/workflowuimodule")
								}
							}
						}
					}
